...
export default function Home () {
  return (
    <Fragment>
      ...
      <div className="flex p-14 justify-center bg-pink-700 mb-12">
        <div className="flex flex-col gap-2 text-white">
          <h2 className="font-bold text-5xl tracking-tight text-center">Jangan Ragu Pilih Mobil Toyota!</h2>
          <p className="font-semibold text-xl text-center tracking-tight mt-1">Pilihan Tepat Keluarga Indonesia. </p>
        </div>
      </div>
      <MaxWidthWrapper>
