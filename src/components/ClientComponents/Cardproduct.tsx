        ...
        <div className="flex flex-col w-full sm:w-80 md:w-[20.5rem] lg:w-[22.5rem] rounded-2xl overflow-hidden border border-gray-300">
           <div className="relative w-full h-40 sm:h-48 cursor-pointer">
              ...
              <div className="absolute flex flex-col left-3 sm:left-4.5 bottom-2 sm:bottom-3.5 text-white">
                ...
                <h2 className="text-xl sm:text-2xl md:text-3xl tracking-wide font-semibold">Rp.3.387.000.000</h2>
              </div>
           </div>
           <div className="flex flex-col p-3 sm:p-4">
              <h2 className="font-semibold text-xl sm:text-2xl mb-2 sm:mb-4 cursor-pointer hover:text-pink-600">BMW The I7</h2>
              <div className="w-full h-0.5 bg-gray-200"></div>
              <div className="flex justify-between items-center mt-2 sm:mt-4">
                <h2 className="text-gray-600 tracking-tight text-xs sm:text-sm">MPV</h2>
