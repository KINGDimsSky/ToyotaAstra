...
export default function FaQ () {
    return (
        ...
        <div className="flex flex-col mt-12">
            ...
            <p className="font-semibold text-base tracking-wide w-[28rem] text-gray-900">Kami mengutamakan kenyamanan dan keselamatan klien kami. Itulah sebabnya kami memberikan layanan terbaik yang dapat Anda bayangkan.</p>
            <div className="flex flex-col gap-2 w-full mt-16">
              ...
              <div className="flex justify-center gap-6 mt-8 flex-wrap">
                {dataBadge.map((data) => (
                  <Badge key={data.id} title={data.title}/>
                ))}
              </div>
            </div>
        </div>
